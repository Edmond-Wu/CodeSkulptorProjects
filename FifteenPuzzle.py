...
class Puzzle:
    ...
    def row0_invariant(self, target_col):
        """
        Check whether tile zero is at (0,j); whether all 
        the rows (and every tile in each row) below 
        (except row1) and all the columns (and every tile 
        in each column) to the right of this position are 
        solved; and additionally it should check whether 
        position (1,j) is also solved
        Returns a boolean
        """
        invariant = True
    ...
    def row1_invariant(self, target_col):
        """
        Check whether tile zero is at (1,j) and whether all 
        the rows (and every tile in each row) below and all 
        the columns (and every tile in each column) to the 
        right of this position are solved
        Returns a boolean
        """
        invariant = True
    ...
    def solve_puzzle(self):
        ...
        #solves first two rows minus the 2x2
